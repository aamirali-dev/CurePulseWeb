...
processor = DataPreprocessor(loader.get_data('2023-09-19'))
    ...
    for linkage in ['ward', 'complete', 'average', 'single']:
        ...
        if n_clusters > 1:
            ...
            if silhouette_avg > best_silhouette_score:
                ...
                best_agg_clustering = agg_clustering
        else:
            best_agg_clustering = agg_clustering

# Visualize the results with the best Agglomerative Clustering model in a 3D scatter plot
...
best_cluster_assignments = best_agg_clustering.labels_
...
ax.set_title('Customer Call Sentiment Clustering (Agglomerative)')
plt.legend()
plt.show()

print("Optimal Number of Clusters:", best_agg_clustering.n_clusters)
print("Optimal Linkage Method:", best_agg_clustering.linkage)
